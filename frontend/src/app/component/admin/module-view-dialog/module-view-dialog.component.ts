...
@Component({
  selector: 'app-module-view-dialog',
  standalone: true,
  imports: [
    CommonModule,
    MatDialogModule,
      ...
      <div class="dialog-header">
        <div class="header-content">
          ...
          <div class="header-text">
            ...
            <p>View complete module information</p>
          </div>
        </div>
          ...
          <div *ngIf="module.documents && module.documents.length > 0" class="documents-list">
            <div *ngFor="let doc of module.documents" class="document-card">
              ...
              <div class="doc-actions">
                <button mat-icon-button (click)="viewDocument(doc.cloudinaryURL)" 
        ...
        <div class="info-section">
          ...
          <div *ngIf="module.video && module.video.cloudinaryURL" class="video-card">
            <div class="video-preview">
              <video [src]="module.video.cloudinaryURL" controls controlsList="nodownload" class="video-player"></video>
            </div>
...
export class ModuleViewDialogComponent {
  constructor(
    public dialogRef: MatDialogRef<ModuleViewDialogComponent>,
